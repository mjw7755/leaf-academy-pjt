...
<!-- top banner -->
	...
	<table id="notewrite_table">
		...
		<tr>
			...
			<td><input type="text" name="n_recv_id" id="n_recv_id" value="${dto.n_send_id }" class="form-control"></td>
		</tr>
		
		<tr>
			<td id="whqrp">제목 : </td>
			<td><input type="text" name="n_title" id="n_title" value="[답장]" class="form-control"></td>
		</tr>
		
		<tr>
			<td id="whqrp">내용 : </td>
			<td><input type="text" name="n_content" id="n_content" style=" height:200px" class="form-control"></td>
		</tr>
		
		<!-- <tr>
			<td><input type="text" name="n_content" id="n_content" style="width:500px; height:200px" class="form-control"></td>
		</tr> -->
