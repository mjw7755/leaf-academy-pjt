			...
			<table>
				...
				<tr>
					<td><input type="text" name="payment_lect_subject"
						value="${cdto.getCurri_subject()}" class="form-control"></td>
					<td><input type="text" name="payment_teacher_name"
						value="${teachername.getMember_name()}" class="form-control"></td>
					<td><input type="text" name="payment_lect_charge"
						value="${ldto.getLect_charge()}" class="form-control"></td>
				</tr>
<%-- 				<tr>
			...
			<table id="home_table">
				...
				<tr>
					...
					<td><input type="text" id="appli_addnum" name="payment_addnum"
						...
						onclick="sample6_execDaumPostcode()" value="우편번호 찾기" class="btn3 btn-primary btn-sm"><br>
			...
			<table id="new_table">
				...
				<tr>
					...
					<td><input type="text" name="payment_addnum"
						id="sample6_postcode" placeholder="우편번호" class="form-control"> <input
						type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" class="btn3 btn-primary btn-sm"><br>
