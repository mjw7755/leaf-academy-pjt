...
<div id="search">	
	...
	<c:forEach items="${jalist }" var="list" varStatus="status">
		<tr onclick="test(this)">
			...
			<td><label id="la1_${list.jageok_id}"  class="la_${list.jageok_id}"  style="display:show;">${list.member_id}</label>		<input type="text" style="width: 100px;display: none;"  id="in1_${list.jageok_id}" class="in_${list.jageok_id }"  value="${list.member_id}"></td>
			<td><label id="la2_${list.jageok_id}"  class="la_${list.jageok_id}"  style="display:show;">${list.jageok_title}</label> 	 <input type="text" style="width: 400px;display: none;"  id="in2_${list.jageok_id}" class="in_${list.jageok_id }"   value="${list.jageok_title}"></td>
			<td><label id="la3_${list.jageok_id}"  class="la_${list.jageok_id}"  style="display:show;">${list.jageok_date}</label> 		 <input type="text" style="width: 200px;display: none;"  id="in3_${list.jageok_id}" class="in_${list.jageok_id }"   value="${list.jageok_date}"></td>
			<td><label id="la4_${list.jageok_id}"  class="la_${list.jageok_id}"  style="display:show;">${list.jageok_cost}</label>		 <input type="text" style="width: 200px;display: none;"  id="in4_${list.jageok_id}" class="in_${list.jageok_id }"   value="${list.jageok_cost}"></td>
			<td><label id="la5_${list.jageok_id}"  class="la_${list.jageok_id}"  style="display:show;">${list.enabled}</label>	 <input type="text" style="width: 55px;display: none;"  id="in5_${list.jageok_id}" class="in_${list.jageok_id }"   value="${list.enabled}"></td>
			<td>
			
			<button type="button"  id="btn_update_by_display_yet_${list.jageok_id}"
				onclick="show1('${list.jageok_id}')" style="display:show;" class="btn2 btn-info">수 정</button> 
				
			<button type="button"  id="btn_update_by_display_now_${list.jageok_id}"
				onclick="show_update('${list.jageok_id}')"  style="display:none;" class="btn2 btn-info">완 료</button> 
			</td>
		</tr>
	</c:forEach>	
</form>
