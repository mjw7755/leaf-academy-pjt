...
<BODY BGCOLOR="#FFFFFF" TOPMARGIN="0" LEFTMARGIN="0" MARGINWIDTH="0"
	MARGINHEIGHT="0" TEXT="#000000" ALINK="#003399" LINK="#003399"
	VLINK="#003399"">
	...
	<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0"
		HEIGHT="100%">
		<TR>
			<TD WIDTH="160" STYLE="BORDER-RIGHT: solid 1px" BORDERCOLOR="#000000"
				VALIGN="TOP">
			...
			<TD WIDTH="15"><IMG SRC="/products/images/spacer.gif" WIDTH="15"
				HEIGHT="5"></TD>
			...
			<TD VALIGN="TOP">
				<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
					<tr>
						...
						<!-- #INCLUDE VIRTUAL="/shared/TopAd.htm" --></td>
					</tr>
					<TR>
						<TD COLSPAN="3" CLASS="productheadersm"><IMG
							SRC="/products/images/spacer.gif" WIDTH="1" HEIGHT="10"></TD>
					</TR>
					...
					<TR>
						...
						<TD CLASS="bodytext" COLSPAN="2" WIDTH="100%">
							...
							<P CLASS="productheadersm">Five in a Row</P>
						</TD>
						<td class="bodytext" nowrap>
							<div align="right">
								<a class="source" href="five_in_a_row.zip" target="_blank">[Download
									Script]</a>
							</div>
						</td>
					</TR>
					...
					<TR>
						...
						<TD CLASS="requiremetssm" COLSPAN="4">Insert into
							&lt;HEAD&gt;</TD>
					</TR>

					<TR>

						<TD CLASS="bodytext" COLSPAN="4"><TEXTAREA STYLE=""
								CLASS="bodytext" ROWS="11" NAME="txt" WIDTH="95%" COLS="100"
								WRAP="OFF"></TEXTAREA> <BR></TD>
					</TR>
					...
					<TR>
						...
						<TD CLASS="requiremetssm" COLSPAN="4" WIDTH="100%">Other
							Options</TD>
					</TR>
