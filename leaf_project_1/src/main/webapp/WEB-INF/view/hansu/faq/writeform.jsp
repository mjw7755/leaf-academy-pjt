...
<form action="faq_write.do" >
	<table id="faqwriteTable">
		<tr>
			...
			<td><input type="text" name="faq_title" style="width: 100%" class="form-control"></td>
		</tr>		
		<tr>
			<td>내용 : </td><!-- faq_content -->
			<td><textarea name="faq_content" style="width: 100%; height:300px" class="form-control"></textarea></td>
		</tr>	
		<tr>
			<td colspan="2">
